// Copied from: https://probablydance.com/2016/12/27/i-wrote-a-faster-sorting-algorithm/
// This supports purely for ska_sort and ska_sort_copy (see blog for more details of usage)
namespace std {
